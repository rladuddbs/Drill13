...
class Zombie:
    ...
    def move_slightly_to(self, tx, ty):
        ...
        self.x += self.speed * math.cos(self.dir) * game_framework.frame_time * self.chase
        self.y += self.speed * math.sin(self.dir) * game_framework.frame_time * self.chase
        pass
    ...
    def build_behavior_tree(self):
        ...
        a4 = Action('소년에 따라 이동', self.move_to_boy)

        SEQ_chase_boy = Sequence('소년을 추적', c1, a4)
        SEQ_flee_boy = Sequence('소년으로부터 도망', c1, a4)

        root = SEL_chase_or_wander = Selector('경쟁 또는 배회', SEQ_chase_boy, SEQ_WANDER)
